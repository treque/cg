...
///
///////////////////////////////////////////////////////////////////////////////
CSkybox::CSkybox(const std::string& nomFichierTexture, float echelle = 1.0)
...
{
    // appliquer la texture de façon personnalisée (mode CLAMP_TO_EDGE)
    obtenirTextures()[0]->appliquer(WRAP_S | WRAP_T | MIN_FILTER | MAG_FILTER, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, 0,
                                    GL_LINEAR, GL_LINEAR, 0, 0, 0, 0, 0, 0, false, GL_TEXTURE0);
}
