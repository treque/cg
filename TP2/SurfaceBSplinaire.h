...
public:
    ...
    CSurfaceBSplinaire(uint numPts_U, uint numPts_V, const Point* Points, uint num_knots_U, uint num_knots_V,
                       const float* knots_U, const float* knots_V, uint NDD = 20, uint degree_U = 3, uint degree_V = 3,
                       uint order_U = 4, uint order_V = 4, float scale_U = 1.0, float scale_V = 1.0);
