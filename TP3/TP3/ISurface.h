...
protected:
    ...
    virtual std::ostream& AfficherInfoDebug(std::ostream& Out) const = 0;
...
public:
    ...
    inline friend std::ostream& operator<<(std::ostream& Out, const ISurface& Surface);
};

///////////////////////////////////////////////////////////////////////////////
///  @brief Afiche une surface vers un flux de sortie
///
...
///  @date   14/08/2008
///////////////////////////////////////////////////////////////////////////////
inline std::ostream& operator<<(std::ostream& Out, const ISurface& Surface)
{
    using std::endl;
