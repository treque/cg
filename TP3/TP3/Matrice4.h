...
public:
    ...
    inline CMatrice4(REAL m00, REAL m01, REAL m02, REAL m03, REAL m10, REAL m11, REAL m12, REAL m13, REAL m20, REAL m21,
    ...
    inline friend std::ostream&   operator<<(std::ostream& Out, const CMatrice4& Mat);
...
///////////////////////////////////////////////////////////////////////////////
///  @brief inline public overloaded constructor
///
...
///  @date   13/08/2008
///////////////////////////////////////////////////////////////////////////////
inline CMatrice4::CMatrice4(REAL m00, REAL m01, REAL m02, REAL m03, REAL m10, REAL m11, REAL m12, REAL m13, REAL m20,
                            REAL m21, REAL m22, REAL m23, REAL m30, REAL m31, REAL m32, REAL m33)
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Opérateur de multiplication (2 matrices)
///
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Multiplication (vecteurs rangée) suppose que la matrice est toujours affine
///
...
///  @date   13/08/2008
///////////////////////////////////////////////////////////////////////////////
inline std::ostream& operator<<(std::ostream& Out, const CMatrice4& Mat)
{
    Out << std::setprecision(3) << std::setw(3) << "| " << Mat.m[0][0] << ", " << Mat.m[0][1] << ", " << Mat.m[0][2]
        << ", " << Mat.m[0][3] << " |" << std::endl
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Fixe la matrice courante à la matrice spécifiée
///
///  @param [in]       Mat const Math3D::CMatrice4 &    La matrice à copier
///
///  @return None
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Effectue une rotation autour de l'axe des X
///
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Effectue une rotation autour de l'axe des Y
///
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Effectue une rotation autour de l'axe des Z axis
///
///  @param [in]       Rad const Math3D::REAL    Radians
///  @param [in]       Ordre const Math3D::CMatrice4::OrdreTransformation [=POST]    Ordre de transfo
///
...
///////////////////////////////////////////////////////////////////////////////
///  @brief effectue une translation
///
...
///////////////////////////////////////////////////////////////////////////////
///  @brief Effectue une mise à l'échelle
///
